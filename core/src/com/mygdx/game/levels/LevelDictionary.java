...
public class LevelDictionary
{
    ...
    {
        m_data.add(
                new LevelData(1, 1, 1, true, 13, 12, 10, 80, false, -10f, -1500f, 2f, new int[] {1,1,0,0,2,0})
        );

        m_data.add(
                new LevelData(2, 1, 2, true, 22, 13, 11, 80, false, -10f, -1500f, 2f, new int[] {2,1,0,0,2,0})
        );
        ...
        m_data.add(
                new LevelData(4, 1, 4, true, 14, 14, 12, 80, false, -11f, -1500f, 2f, new int[] {0,1,0,1,0})
        );

        m_data.add(
                new LevelData(5, 1, 5, true, 15, 15, 13, 80, false, -11f, -1500f, 2f, new int[] {0,1,2,1,0})
        );

        m_data.add(
                new LevelData(6, 1, 6, true, 30, 13, 11, 80, true, -11f, -1500f, 2f, new int[] {2,1,0,2,1})
        );

        m_data.add(
                new LevelData(7, 1, 7, true, 16, 16, 14, 80, false, -12f, -1500f, 2f, new int[] {2,1,0,1,0})
        );
        ...
        m_data.add(
                new LevelData(9, 1, 9, true, 25, 13, 11, 80, true, -12f, -1500f, 2f, new int[] {2,1,0,2,1})
        );
    }
}
