...
public class LevelDictionary
{
    ...
    {
        m_data.add(
            new LevelData(1, 1, 1, true, 13, 2, 5, 80, false, -10f, -1100f, 2f, new int[] {0,0,0,0,0,0,0})
        );

        m_data.add(
            new LevelData(2, 1, 2, true, 15, 8, 5, 80, false, -10f, -1200f, 2f, new int[] {0,1,0,1,0,0})
        );

        m_data.add(
            new LevelData(3, 1, 3, true, 40, 8, 5, 80, true, -10f, -1200f, 2f, new int[] {2,1,0,2,1})
        );

        m_data.add(
            new LevelData(4, 1, 4, true, 14, 9, 6, 80, false, -11f, -1300f, 2f, new int[] {0,1,1,0,1})
        );

        m_data.add(
            new LevelData(5, 1, 5, true, 15, 9, 6, 80, false, -11f, -1300f, 2f, new int[] {0,1,1,0,1})
        );

        m_data.add(
            new LevelData(6, 1, 6, true, 35, 9, 6, 80, true, -11f, -1300f, 2f, new int[] {2,1,0,2,0})
        );

        m_data.add(
            new LevelData(7, 1, 7, true, 16, 10, 8, 80, false, -12f, -1400f, 2f, new int[] {0,1,2,0,0})
        );

        m_data.add(
            new LevelData(8, 1, 8, true, 17, 10, 8, 80, false, -12f, -1400f, 2f, new int[] {0,1,2,1,0})
        );

        m_data.add(
            new LevelData(9, 1, 9, true, 25, 10, 8, 80, true, -12f, -1400f, 2f, new int[] {2,1,0,2,0,1})
        );
    }
